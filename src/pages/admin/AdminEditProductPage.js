                ...
                <Col md={6}>
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPrice">
                            ...
                            <Form.Control name="price" required type="text" defaultValue="$230" />
                        </Form.Group>
                        ...
                        <Form.Group controlId="formFileMultiple" className="mb-3 mt-3">
                            ...
                            <Row>
                                <Col style={{position:"relative"}} xs={3} >
                                    <Image crossOrigin="anonymous" src="/images/monitors-category.png" fluid></Image>
                                    <i style={onHover} className="bi bi-x text-danger"></i>
                                </Col>
                                <Col style={{position:"relative"}} xs={3} >
                                    <Image src="/images/monitors-category.png" fluid></Image>
                                    <i style={onHover} className="bi bi-x text-danger"></i>
                                </Col> 
                            </Row>
