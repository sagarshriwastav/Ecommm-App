            ...
            <Row className="mt-5">
                ...
                <Col md={8}>
                    <Row>
                        <Col md={8}>
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>This product is best in price, best in quality also best in category.100% Original must purchase. World best product ranges available only on Shop SAGA.</ListGroup.Item>
                            </ListGroup>
                        </Col>
                        <Col md={4}>
                            <ListGroup>
                        ...
                        <Col className="mt-5">
                            ...
                            <ListGroup variant="flush">
                                {Array.from({ length: 10 }).map((item, idx) => (
                                    <ListGroup.Item key={idx} >Aditya <br />
                                        <Rating readonly size={20} initialValue={4} />
                                        <br />
                                        30-06-2000 <br />
                                        This product is excellent. I never used any product like this awesome.. happy to purchase it.
                                    </ListGroup.Item>
                                ))}
                            </ListGroup>
                        </Col>
                    ...
                    <Form>
                        ...
                        <Button className="mt-3 mb-3" variant="primary">Submit</Button>
                    </Form>
                </Col>
            </Row>
        </Container>
